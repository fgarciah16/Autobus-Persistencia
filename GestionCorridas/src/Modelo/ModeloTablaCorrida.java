...
import GestionCorrida.ReservaJpaController;
...
public ModeloTablaCorrida(List<Corridas> corridas,String nomColumnas[]){
	datos=corridas;
	encabezado= nomColumnas;
        emf=Persistence.createEntityManagerFactory("GestionCorridaPU");
